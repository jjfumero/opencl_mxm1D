// Other kernels to experiments with generated kernels from OpenJDK Babylon (HAT).
...
// This version uses an array of struct to access the thread-id. This is more expensive that the previous kernel due to 
...
// This version produces WRONG RESULTS due to a race condition. This is just for testing 
// and comparing the kernel time with other versions, since OpenJDK Babylon, as in November 2024,
// produces a similar kernel. 
// [IMPORTANT] This kernel is just for testing. 
